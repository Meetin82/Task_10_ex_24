...
public class JTableUtils {
    ...
    public static void initJTableForArray(
        ...
        DefaultTableModel tableModel = new DefaultTableModel(1, 5) {
            @Override
            public String getColumnName(int index) {
                String[] columnName = {"ФИО", "Наличие аттестата", "Баллы по математике", "Баллы по физике", "Баллы по русскому языку"};
